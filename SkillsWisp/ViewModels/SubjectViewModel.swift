    ...
    func fetchAllNotes(){
        ...
        do {
            ...
            for note in fetchedNotes {
                savedEntities.append(NoteModel(noteId: note.notes_id?.uuidString ?? "UNKNOWN", name: note.name, chapter: note.chapter, rating: note.rating, localUrl: note.local_url, likesCount: Int(note.likes_count), reviewCount: 0, bookmark: note.bookmark, thumbnail: ""))
            }
        } catch {
